...
class Persona {
    ...
    // Se sobreescribe el metodo toString de la clase Object para que el objeto pueda imprimirse como un string.
...
let persona = new Persona("Agustin", 27, "12345678"); // Instancia de la clase Persona.
...
let persona2 = new Persona("Agustin", 27);
...
class Empleado extends Persona { // Se crea una clase Empleado que hereda de Persona.
    ...
    constructor(nombre, edad, dni, sueldo) {
        ...
        super(nombre, edad, dni); // Se llama al constructor de la clase padre.
