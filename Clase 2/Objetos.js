...
console.log(objeto === objeto2); // Compara función de su contenido y tipo de dato. Imprime true.
 ...
 // Las llaves indican que se está creando un objeto y con los 3 puntos se exparsen los atributos del objeto original.
...
const detallar = ({username, email}) => { // Se crea una función que recibe un objeto y lo desestructura.
...
auto.modelo = "Focus"; 
auto["tipo"] = "Nafta"; // Otra forma de crear un atributo
